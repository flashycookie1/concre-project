  ...
  return (
    ...
    <div className="challengeDiv">
      <p className="challengetxt" style={{maxWidth: '820px'}}>
        THE CHALLENGE: Design and build a concrete canoe according to ASCE
        ...
        paper, presenting to a panel of judges, and racing against other teams at
      ...
      <p className="interested">
        ...
        <div className="theme">
            <p style={{color: "#F2D027"}}>UCONN Concrete Canoe 2024-2025 Presents:</p>
                <img src={uconnstellation} style={{width: '65%'}}></img>
            <p style={{width: '60%'}}>
                Stay Tuned! Follow <a
                    className="hover-underline-animation"
                    href={instagram}
        ...
        <div style={{ display: 'flex', justifyContent: 'center', maxWidth:'400px' }}>
            <InstagramEmbed url="https://www.instagram.com/uconnconcretecanoe" width={400} style={{padding: 20}}/>
        </div>
        </div>
        </div>
    </>
